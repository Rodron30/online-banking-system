...
public class DataInitializer {
    ...
    CommandLineRunner initializeUsers(
        ...
        return args -> {
            ...
            // Keep the default admin role and credentials available.
            // Password/PIN are only encoded again when needed, instead
            // of generating a new BCrypt hash on every application restart.
            ...
            // Keep the default demo role and credentials available.
